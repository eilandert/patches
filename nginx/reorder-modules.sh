...
#    if [ ! -f "${MODPATH}/${MODULE}.conf" ]; then
#        echo "[NGINX] ${MODPATH}/${MODULE}.conf not found, not doing any changes."
#        if [ -f "/.dockerenv" ]; then
#            logger "[NGINX] ${MODPATH}/${MODULE}.conf not found, not doing any changes."
#        fi
#    else
